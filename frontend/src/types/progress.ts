...
export type ClinicRecordUpdateRequest = components["schemas"]["ClinicRecordUpdateRequest"];
export type ClinicRecordResponse = components["schemas"]["ClinicRecordResponse"];
