...
| 엔티티                         | 설명                                                                     |
| ------------------------------ | ------------------------------------------------------------------------ |
| **Company**                    | 학원/회사 정보 (type: INDIVIDUAL/ACADEMY, verifiedStatus: UNVERIFIED/VERIFIED) |
| **Branch**                     | 학원 지점 정보 (creatorMemberId, verifiedStatus: UNVERIFIED/VERIFIED)    |
...
| **StudentCourseRecord**        | 반별 학생 기록 (teacherNotes, defaultClinicSlotId, assistantMemberId)    |
...
- **Company, Branch**: VerifiedStatus(UNVERIFIED/VERIFIED) 도입 + Branch.creatorMemberId/Assignment 역할 규칙 추가
