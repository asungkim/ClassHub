...
| ClinicAttendances         | /clinic-attendances, /students/me/clinic-attendances | 출석 조회, 학생 추가 신청/이동 API                                    |
...
- 학생 추가 신청은 `clinicSessionId`와 `studentCourseRecordId`를 전달하며, 동일 teacher/branch 및 시간 겹침 여부를 검증한다.
